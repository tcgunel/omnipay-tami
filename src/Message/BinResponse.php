...
class BinResponse extends AbstractResponse
{
    protected $response;
    ...
    {
        return $this->data['bankName'] ?? null;
    }

    public function getBankId(): ?string
    {
        return $this->data['bankId'] ?? null;
    }
    ...
    public function getCardOrg(): ?string
    {
        return $this->data['cardOrg'] ?? null;
    }

    public function getRewardType(): ?string
    {
        return $this->data['rewardType'] ?? null;
    }

    public function isCommercial(): bool
    {
        return ! empty($this->data['commercial']);
    }
